...
ohlc_history_in_dataframe = get_ohlc_history_in_dataframe(symbol, time_interval, '2020-01-01', '2021-01-01')
        ...
        if index % 10 == 0: # project every 10 trading days
            ...
            if sumarized['mean_return'] > 0.3:
                ...
                date_to_object_dict[date] ={
                    'direction': 1,
                    'take_profit_perc': sumarized['mean_return'] ,
                    # 'stop_loss_perc': sumarized['mean_return'] * 0.5,
                ...
                date_to_object_dict[date] = {
                        'direction': -1,
                        'take_profit_perc': -1*(sumarized['mean_return']), # make it positive
                        # 'stop_loss_perc': sumarized['mean_return'] * 0.5,
